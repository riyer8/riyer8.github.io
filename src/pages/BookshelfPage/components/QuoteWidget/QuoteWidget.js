...
const QuoteWidget = () => {
  ...
  return (
    <aside
      className={`bookshelf-quote${theme.isDarkMode ? " bookshelf-quote--dark" : ""}`}
      style={{
    ...
    >
      <p className="bookshelf-quote__label">from my notes · today</p>
      ...
      <footer className="bookshelf-quote__footer">
        ...
        <Link to={`/recent-reads/${slug}`} className="bookshelf-quote__link">
          open notes
        </Link>
      </footer>
    </aside>
